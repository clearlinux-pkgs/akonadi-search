...
%prep
%setup -q -n akonadi-search-19.12.1
cd %{_builddir}/akonadi-search-19.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578928014
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/akonadi-search-19.12.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/akonadi-search/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5AkonadiSearchCore.so.5.13.1
/usr/lib64/libKF5AkonadiSearchDebug.so.5
/usr/lib64/libKF5AkonadiSearchDebug.so.5.13.1
/usr/lib64/libKF5AkonadiSearchPIM.so.5
/usr/lib64/libKF5AkonadiSearchPIM.so.5.13.1
/usr/lib64/libKF5AkonadiSearchXapian.so.5
/usr/lib64/libKF5AkonadiSearchXapian.so.5.13.1
