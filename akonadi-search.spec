...
Requires: akonadi-search-bin
Requires: akonadi-search-lib
Requires: akonadi-search-data
Requires: akonadi-search-license
Requires: akonadi-search-locales
...
%prep
%setup -q -n akonadi-search-18.08.0
...
cp COPYING.LIB %{buildroot}/usr/share/doc/akonadi-search/COPYING.LIB
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5AkonadiSearchCore.so.5.9.0
/usr/lib64/libKF5AkonadiSearchDebug.so.5
/usr/lib64/libKF5AkonadiSearchDebug.so.5.9.0
/usr/lib64/libKF5AkonadiSearchPIM.so.5
/usr/lib64/libKF5AkonadiSearchPIM.so.5.9.0
/usr/lib64/libKF5AkonadiSearchXapian.so.5
/usr/lib64/libKF5AkonadiSearchXapian.so.5.9.0
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/akonadi-search/COPYING
/usr/share/doc/akonadi-search/COPYING.LIB
