...
Version  : 22.08.0
Release  : 45
URL      : https://download.kde.org/stable/release-service/22.08.0/src/akonadi-search-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/akonadi-search-22.08.0.tar.xz
...
%prep
%setup -q -n akonadi-search-22.08.0
cd %{_builddir}/akonadi-search-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661563350
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5AkonadiSearchCore.so.5.21.0
/usr/lib64/libKF5AkonadiSearchDebug.so.5
/usr/lib64/libKF5AkonadiSearchDebug.so.5.21.0
/usr/lib64/libKF5AkonadiSearchPIM.so.5
/usr/lib64/libKF5AkonadiSearchPIM.so.5.21.0
/usr/lib64/libKF5AkonadiSearchXapian.so.5
/usr/lib64/libKF5AkonadiSearchXapian.so.5.21.0
