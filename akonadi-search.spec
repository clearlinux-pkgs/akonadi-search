...
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/akonadi-search-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/akonadi-search-24.12.0.tar.xz.sig
...
%setup -q -n akonadi-search-24.12.0
cd %{_builddir}/akonadi-search-24.12.0
pushd ..
cp -a akonadi-search-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735255816
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6AkonadiSearchCore.so.6.3.0
/V3/usr/lib64/libKPim6AkonadiSearchDebug.so.6.3.0
/V3/usr/lib64/libKPim6AkonadiSearchPIM.so.6.3.0
/V3/usr/lib64/libKPim6AkonadiSearchXapian.so.6.3.0
...
/usr/lib64/libKPim6AkonadiSearchCore.so.6.3.0
/usr/lib64/libKPim6AkonadiSearchDebug.so.6
/usr/lib64/libKPim6AkonadiSearchDebug.so.6.3.0
/usr/lib64/libKPim6AkonadiSearchPIM.so.6
/usr/lib64/libKPim6AkonadiSearchPIM.so.6.3.0
/usr/lib64/libKPim6AkonadiSearchXapian.so.6
/usr/lib64/libKPim6AkonadiSearchXapian.so.6.3.0
