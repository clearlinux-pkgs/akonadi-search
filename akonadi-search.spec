...
Version  : 22.12.0
Release  : 49
URL      : https://download.kde.org/stable/release-service/22.12.0/src/akonadi-search-22.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/akonadi-search-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/akonadi-search-22.12.0.tar.xz.sig
...
%prep
%setup -q -n akonadi-search-22.12.0
cd %{_builddir}/akonadi-search-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670784342
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5AkonadiSearchCore.so.5.22.0
/usr/lib64/libKF5AkonadiSearchDebug.so.5
/usr/lib64/libKF5AkonadiSearchDebug.so.5.22.0
/usr/lib64/libKF5AkonadiSearchPIM.so.5
/usr/lib64/libKF5AkonadiSearchPIM.so.5.22.0
/usr/lib64/libKF5AkonadiSearchXapian.so.5
/usr/lib64/libKF5AkonadiSearchXapian.so.5.22.0
