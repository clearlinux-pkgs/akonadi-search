...
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/akonadi-search-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/akonadi-search-22.12.1.tar.xz.sig
...
%prep
%setup -q -n akonadi-search-22.12.1
cd %{_builddir}/akonadi-search-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673384972
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5AkonadiSearchCore.so.5.22.1
/usr/lib64/libKF5AkonadiSearchDebug.so.5
/usr/lib64/libKF5AkonadiSearchDebug.so.5.22.1
/usr/lib64/libKF5AkonadiSearchPIM.so.5
/usr/lib64/libKF5AkonadiSearchPIM.so.5.22.1
/usr/lib64/libKF5AkonadiSearchXapian.so.5
/usr/lib64/libKF5AkonadiSearchXapian.so.5.22.1
