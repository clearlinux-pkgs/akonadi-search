...
Version  : 18.12.2
Release  : 3
URL      : https://download.kde.org/stable/applications/18.12.2/src/akonadi-search-18.12.2.tar.xz
Source0  : https://download.kde.org/stable/applications/18.12.2/src/akonadi-search-18.12.2.tar.xz
...
%prep
%setup -q -n akonadi-search-18.12.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1549857214
mkdir -p clr-build
pushd clr-build
%cmake ..
...
/usr/lib64/libKF5AkonadiSearchCore.so.5.10.2
/usr/lib64/libKF5AkonadiSearchDebug.so.5
/usr/lib64/libKF5AkonadiSearchDebug.so.5.10.2
/usr/lib64/libKF5AkonadiSearchPIM.so.5
/usr/lib64/libKF5AkonadiSearchPIM.so.5.10.2
/usr/lib64/libKF5AkonadiSearchXapian.so.5
/usr/lib64/libKF5AkonadiSearchXapian.so.5.10.2
