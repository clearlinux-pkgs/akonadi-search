...
Version  : 22.08.2
Release  : 47
URL      : https://download.kde.org/stable/release-service/22.08.2/src/akonadi-search-22.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.2/src/akonadi-search-22.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.2/src/akonadi-search-22.08.2.tar.xz.sig
...
%prep
%setup -q -n akonadi-search-22.08.2
cd %{_builddir}/akonadi-search-22.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665774942
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5AkonadiSearchCore.so.5.21.2
/usr/lib64/libKF5AkonadiSearchDebug.so.5
/usr/lib64/libKF5AkonadiSearchDebug.so.5.21.2
/usr/lib64/libKF5AkonadiSearchPIM.so.5
/usr/lib64/libKF5AkonadiSearchPIM.so.5.21.2
/usr/lib64/libKF5AkonadiSearchXapian.so.5
/usr/lib64/libKF5AkonadiSearchXapian.so.5.21.2
