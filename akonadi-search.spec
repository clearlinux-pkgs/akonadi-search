...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/akonadi-search-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/akonadi-search-24.02.0.tar.xz.sig
...
%prep
%setup -q -n akonadi-search-24.02.0
cd %{_builddir}/akonadi-search-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710424680
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6AkonadiSearchCore.so.6.0.0
/V3/usr/lib64/libKPim6AkonadiSearchDebug.so.6.0.0
/V3/usr/lib64/libKPim6AkonadiSearchPIM.so.6.0.0
/V3/usr/lib64/libKPim6AkonadiSearchXapian.so.6.0.0
...
/usr/lib64/libKPim6AkonadiSearchCore.so.6.0.0
/usr/lib64/libKPim6AkonadiSearchDebug.so.6
/usr/lib64/libKPim6AkonadiSearchDebug.so.6.0.0
/usr/lib64/libKPim6AkonadiSearchPIM.so.6
/usr/lib64/libKPim6AkonadiSearchPIM.so.6.0.0
/usr/lib64/libKPim6AkonadiSearchXapian.so.6
/usr/lib64/libKPim6AkonadiSearchXapian.so.6.0.0
