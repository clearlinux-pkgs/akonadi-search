...
Version  : 24.12.1
Release  : 82
URL      : https://download.kde.org/stable/release-service/24.12.1/src/akonadi-search-24.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/akonadi-search-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/akonadi-search-24.12.1.tar.xz.sig
...
%setup -q -n akonadi-search-24.12.1
cd %{_builddir}/akonadi-search-24.12.1
pushd ..
cp -a akonadi-search-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736546323
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6AkonadiSearchCore.so.6.3.1
/V3/usr/lib64/libKPim6AkonadiSearchDebug.so.6.3.1
/V3/usr/lib64/libKPim6AkonadiSearchPIM.so.6.3.1
/V3/usr/lib64/libKPim6AkonadiSearchXapian.so.6.3.1
...
/usr/lib64/libKPim6AkonadiSearchCore.so.6.3.1
/usr/lib64/libKPim6AkonadiSearchDebug.so.6
/usr/lib64/libKPim6AkonadiSearchDebug.so.6.3.1
/usr/lib64/libKPim6AkonadiSearchPIM.so.6
/usr/lib64/libKPim6AkonadiSearchPIM.so.6.3.1
/usr/lib64/libKPim6AkonadiSearchXapian.so.6
/usr/lib64/libKPim6AkonadiSearchXapian.so.6.3.1
