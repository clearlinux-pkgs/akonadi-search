...
Version  : 19.12.2
Release  : 20
URL      : https://download.kde.org/stable/release-service/19.12.2/src/akonadi-search-19.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.2/src/akonadi-search-19.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.2/src/akonadi-search-19.12.2.tar.xz.sig
...
%prep
%setup -q -n akonadi-search-19.12.2
cd %{_builddir}/akonadi-search-19.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581088446
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/akonadi-search-19.12.2/COPYING %{buildroot}/usr/share/package-licenses/akonadi-search/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/akonadi-search-19.12.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/akonadi-search/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5AkonadiSearchCore.so.5.13.2
/usr/lib64/libKF5AkonadiSearchDebug.so.5
/usr/lib64/libKF5AkonadiSearchDebug.so.5.13.2
/usr/lib64/libKF5AkonadiSearchPIM.so.5
/usr/lib64/libKF5AkonadiSearchPIM.so.5.13.2
/usr/lib64/libKF5AkonadiSearchXapian.so.5
/usr/lib64/libKF5AkonadiSearchXapian.so.5.13.2
